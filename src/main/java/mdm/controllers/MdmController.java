package mdm.controllers;

import com.google.gson.Gson;
import lombok.extern.log4j.Log4j2;
import mdm.models.DataMdmObjectsAttributesUpload;
import mdm.models.DataMdmObjectsUpload;
...
public class MdmController {
    ...
    private static void send(ArrayList<DataMdmObjectsAttributesUpload> attributesArrayList, Integer objectTypeId) {
        try {
            ...
            mdmObject.setSprMdmObjectTypeId(objectTypeId);
            ...
            gson.toJson(mdmObject, DataMdmObjectsUpload.class);
...
//             * ******** Ticked Issued 4 ********
//             */
//            UUID ticket_mfc_uuid = UUID.randomUUID();
...
//            attributesArrayList4.add(new DataMdmObjectsAttributesUpload(202, customer.getStandTime() + " +03"));
...
//             * ******** Ticked Issued 2 ********
//             */
//            UUID ticket_issued_mfc_uuid = UUID.randomUUID();
...
//            attributesArrayList2.add(new DataMdmObjectsAttributesUpload(3, customer.getStandTime() + " +03"));
...
//        if (customer != null) {
//            log.debug("МДМ плагин. Вызовим кастомера под номером " + customer.getFullNumber());
//
//            /**
//             * ******** Ticked Issued 3 ********
//             */
...
//            attributesArrayList3.add(new DataMdmObjectsAttributesUpload(8, customer.getCallTime() + " +03"));
//            attributesArrayList3.add(new DataMdmObjectsAttributesUpload(187, customer.getUser().getId().toString()));
//            attributesArrayList3.add(new DataMdmObjectsAttributesUpload(192, customer.getId().toString()));
//
//            send(attributesArrayList3, 3);
//        } else {
//            log.error("МДМ плагин [inviteNextCustomer]. Ошибка, кастомер почему-то null, проверь код :(");
//        }
//    }
//
...
//    }
//
//    public static void getFinishCustomer(QCustomer customer, QUser user) {
//        if (customer != null) {
//            final ArrayList<DataMdmObjectsAttributesUpload> attributesArrayList9 = new ArrayList<>();
//            attributesArrayList9.add(new DataMdmObjectsAttributesUpload(36, ""));
//            attributesArrayList9.add(new DataMdmObjectsAttributesUpload(37, customer.getStartTime() + " +03"));
//            attributesArrayList9.add(new DataMdmObjectsAttributesUpload(38, customer.getFinishTime() + " +03"));
//            attributesArrayList9.add(new DataMdmObjectsAttributesUpload(39, user.getPoint()));
//            attributesArrayList9.add(new DataMdmObjectsAttributesUpload(40, user.getUserUuid()));
//            attributesArrayList9.add(new DataMdmObjectsAttributesUpload(41, customer.getId().toString()));
//            attributesArrayList9.add(new DataMdmObjectsAttributesUpload(42, "0"));
//
//            send(attributesArrayList9, 5);
//        } else {
